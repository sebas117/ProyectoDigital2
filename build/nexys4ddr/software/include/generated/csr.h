...
/* camara_cntrl */
#define CSR_CAMARA_CNTRL_BASE (CSR_BASE + 0x3000L)
#define CSR_CAMARA_CNTRL_COLOR_ADDR (CSR_BASE + 0x3000L)
...
#define CSR_CAMARA_CNTRL_FIGURE_ADDR (CSR_BASE + 0x3004L)
...
#define CSR_CAMARA_CNTRL_DONE_ADDR (CSR_BASE + 0x3008L)
...
#define CSR_CAMARA_CNTRL_INIT_PROCESAMIENTO_ADDR (CSR_BASE + 0x300cL)
...
#define CSR_CAMARA_CNTRL_EV_STATUS_ADDR (CSR_BASE + 0x3010L)
...
#define CSR_CAMARA_CNTRL_EV_PENDING_ADDR (CSR_BASE + 0x3014L)
...
#define CSR_CAMARA_CNTRL_EV_ENABLE_ADDR (CSR_BASE + 0x3018L)
...
/* pwm_cntrl */
#define CSR_PWM_CNTRL_BASE (CSR_BASE + 0x3800L)
#define CSR_PWM_CNTRL_ENABLE_ADDR (CSR_BASE + 0x3800L)
...
#define CSR_PWM_CNTRL_PERIOD_ADDR (CSR_BASE + 0x3804L)
...
#define CSR_PWM_CNTRL_DUTTY_ADDR (CSR_BASE + 0x3808L)
...
#define CSR_INFRA_CNTRL_OUT_INFRA_ADDR (CSR_BASE + 0x4000L)
#define CSR_INFRA_CNTRL_OUT_INFRA_SIZE 1
static inline uint32_t infra_cntrl_out_infra_read(void) {
	return csr_read_simple(CSR_BASE + 0x4000L);
}
#define CSR_INFRA_CNTRL_CONTROL_BANDA_ADDR (CSR_BASE + 0x4004L)
#define CSR_INFRA_CNTRL_CONTROL_BANDA_SIZE 1
static inline uint32_t infra_cntrl_control_banda_read(void) {
	return csr_read_simple(CSR_BASE + 0x4004L);
}
static inline void infra_cntrl_control_banda_write(uint32_t v) {
